...
class Context(object):
    ...
    def __init__(self, method, service, environ, ssl_mode, ssl_only=SSL_ONLY):
        self.method = method
    ...
    def _parse_cookies(self):
        ...
        if ', ' in cookie_data:
            cookie_data = '; '.join(cookie_data.split(', '))
        if cookie_data:
...
def handle_http_request(
    ...
    try:
        ...
        ctx = Context(http_method, service_name, env, ssl_mode)
